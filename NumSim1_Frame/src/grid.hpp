...
public:
  ...
  /// Computes d(v*u)/dy with the donor cell method
  real_t DC_dvu_dy(const Iterator &it, const real_t &alpha, const Grid *v) const;
  /// Computes d(u*v)/dx with the donor cell method
  real_t DC_duv_dx(const Iterator &it, const real_t &alpha, const Grid *u) const;
